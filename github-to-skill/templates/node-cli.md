...
This skill provides CLI interface for {{repo_name}} (Node.js).
...
1. Requires Node.js {{node_version}}+
2. {{constraint_1}}
3. {{constraint_2}}
...
def run_cli(args: list[str]) -> subprocess.CompletedProcess:
    ...
    # Use npx or direct path to binary
    cmd = ["npx", "{{cli_name}}", *args]
    # Alternative: cmd = [str(REPO_PATH / "{{entry_script}}"), *args]
